CalcGcd. C Tutorials. Microsoft Visual Studio IDE. Simple Input/Output. Algorithms. Console application. 
...
The program does the following:
  ...
  4. In a loop with a precondition, the Euclidean algorithm is executed:
    ...
    4.3. If the first number is greater than the second, then the second number is subtracted from the first;
         otherwise, the first number is subtracted from the second.
